...
//         <div
//           className="row offer-slider-fade-left"
//            data-aos="fade-left"
//            data-aos-offset="500"
//            data-aos-delay="200"
...
//       img: offerRocket,
//       title: 'Explore, Earn, Elevate',
//       content: 'Every referral fuels your journey, climb the ranks and claim your rewards!',
//     },
//     {
//       id: 2,
//       img: offerastro,
//       title: 'Reach for Rewards, Refer for More!',
//       content: 'Invite your friends, collect cosmic points, and unlock stellar perks!',
//     },
//     {
//       id: 3,
//       img: offersolor,
...
//           <Slider className="offer-slider" {...settings}>
//             {cards?.map((card, index) => (
//               <div className={`d-flex offer-cards offer-bg-img-${card?.id}`} key={index}>
//                 <div className="col-lg-7 ms-3 ps-3 my-3 py-3 d-grid align-items-end">
//                   <h3 className="text-white font-36 montserrat-semibold mb-2 pb-1 truncate-text-2 lh-sm">
//                     {card.title}
//                   </h3>
